...
{
QFile baza_danych("C:/Users/wojta/Desktop/wizualizacja/projekt010/test.txt");
...
void MainWindow::on_button_clicked()
{
    ...
    okno_szczytu->show();
    okno_szczytu->setFixedSize(1201, 480);
...
void MainWindow::on_actionPrze_cz_widok_mapy_triggered()
{
    QPixmap bck(":/zasoby/images/back.png");
   QPixmap bck2(":/zasoby/images/topo.jpg");
   if(tlo == "AB"){
