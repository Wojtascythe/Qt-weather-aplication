...
void MainWindow::on_pushButton_3_clicked()
{
    ...
    QNetworkReply *response = manager.get(QNetworkRequest(QUrl("view-source:http://www.skifever.pl/prognoza-pogody-na-narty/prognoza-pogody-polska/prognoza-pogody-dolnoslaskie?tl=9")));
    QEventLoop event;
...
void MainWindow::on_actionAktualizacja_Danych_triggered()
{
    ...
    QFile  karpacz_source("C:/Users/wojta/Desktop/wizualizacja/projekt013/images/karpacz.txt");
    karpacz_source.open(QIODevice::ReadWrite);
    QTextStream in1 (&karpacz_source);
    QString line;
    do {
        line = in1.readLine();
        if(line.contains("1.png"))kar_n=1;
        if(line.contains("2.png"))kar_n=2;
        if(line.contains("3.png"))kar_n=2;
        if(line.contains("4.png"))kar_n=3;
        if(line.contains("5.png"))kar_n=4;
        if(line.contains("9.png"))kar_n=4;
        if(line.contains("7.png"))kar_n=5;
}while (!line.isNull());
     karpacz_source.close();
    QFile  zieleniec_source("C:/Users/wojta/Desktop/wizualizacja/projekt013/images/zieleniec.txt");
    zieleniec_source.open(QIODevice::ReadWrite);
    QTextStream in2 (&zieleniec_source);

    do {
        line = in2.readLine();
        if(line.contains("1.png"))ziel_n=1;
        if(line.contains("2.png"))ziel_n=2;
        if(line.contains("3.png"))ziel_n=2;
        if(line.contains("4.png"))ziel_n=3;
        if(line.contains("5.png"))ziel_n=4;
        if(line.contains("9.png"))ziel_n=4;
        if(line.contains("7.png"))ziel_n=5;
}while (!line.isNull());
     zieleniec_source.close();
    QFile  szczyrk_source("C:/Users/wojta/Desktop/wizualizacja/projekt013/images/szczyrk.txt");
    szczyrk_source.open(QIODevice::ReadWrite);
    QTextStream in3 (&szczyrk_source);

    do {
        line = in3.readLine();
        if(line.contains("1.png"))sz_n=1;
        if(line.contains("2.png"))sz_n=2;
        if(line.contains("3.png"))sz_n=2;
        if(line.contains("4.png"))sz_n=3;
        if(line.contains("5.png"))sz_n=4;
        if(line.contains("9.png"))sz_n=4;
        if(line.contains("7.png"))sz_n=5;
}while (!line.isNull());
     szczyrk_source.close();
    QFile  krynica_source("C:/Users/wojta/Desktop/wizualizacja/projekt013/images/krynica.txt");
    krynica_source.open(QIODevice::ReadWrite);
    QTextStream in4 (&krynica_source);

    do {
        line = in4.readLine();
        if(line.contains("1.png"))kry_n=1;
        if(line.contains("2.png"))kry_n=2;
        if(line.contains("3.png"))kry_n=2;
        if(line.contains("4.png"))kry_n=3;
        if(line.contains("5.png"))kry_n=4;
        if(line.contains("9.png"))kry_n=4;
        if(line.contains("7.png"))kry_n=5;
}while (!line.isNull());
